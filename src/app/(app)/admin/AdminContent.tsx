...
export function AdminContent() {
  ...
  // Add user state: track which family's form is open
    ...
    <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <input
              ...
              className={cn(
                ...
                "focus:outline-none focus:ring-2 focus:ring-[var(--c-black)]/20"
              )}
            />
          </div>
          <button
      ...
      <section className="space-y-4">
        ...
        {isLoading ? (
          ...
          families.map((family) => (
            <div key={family.id} className="bg-[var(--c-gray)] rounded-3xl p-5 md:p-6">
              {/* Family header */}
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-[#999] mt-0.5">
                    {family._count.users}{" "}
                    {family._count.users === 1
                      ? "участник"
                      : family._count.users < 5
                        ? "участника"
                        : "участников"}
                  </p>
                </div>
              ...
              {addUserFamilyId === family.id && (
                <form
                  ...
                  className="border-t-2 border-white pt-4 space-y-4"
                >
                  ...
                  <div className="flex flex-wrap gap-3">
                    <div className="flex-1 min-w-[150px]">
                      ...
                      <input
                        ...
                        className={cn(
                          "w-full rounded-2xl border-2 border-[var(--c-black)] bg-white px-4 py-3 text-sm font-medium",
                          "text-[var(--c-black)] placeholder:text-[#bbb] focus:outline-none"
                        )}
                      />
                    </div>
                    <div className="flex-1 min-w-[150px]">
          ...
          <div className="bg-[var(--c-gray)] rounded-3xl p-10 text-center">
